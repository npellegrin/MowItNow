...
public class MowerRunnerTest {
	...
	private ParserDefinition buildParserDefinitionStub() {
		...
		final PositionDefinition initialPosition = new PositionDefinition();
	...
	public void should_run_simple_definition() {
		...
		final PublicOrientation orientation = new PublicOrientation(listener.getMessageList().get(0).getOrientation());
